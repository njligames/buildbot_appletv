...
# Import target "NJLIC::NJLICFramework" for configuration "RelWithDebInfo"
set_property(TARGET NJLIC::NJLICFramework APPEND PROPERTY IMPORTED_CONFIGURATIONS RELWITHDEBINFO)
set_target_properties(NJLIC::NJLICFramework PROPERTIES
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/framework/NJLICFramework.framework/NJLICFramework"
  IMPORTED_SONAME_RELWITHDEBINFO "@rpath/NJLICFramework.framework/NJLICFramework"
  )
...
# Import target "NJLIC::NJLIC-lua-swig-bullet3" for configuration "RelWithDebInfo"
set_property(TARGET NJLIC::NJLIC-lua-swig-bullet3 APPEND PROPERTY IMPORTED_CONFIGURATIONS RELWITHDEBINFO)
set_target_properties(NJLIC::NJLIC-lua-swig-bullet3 PROPERTIES
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/lib/libNJLIC-lua-swig-bullet3.dylib"
  IMPORTED_SONAME_RELWITHDEBINFO "@rpath/libNJLIC-lua-swig-bullet3.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS NJLIC::NJLIC-lua-swig-bullet3 )
list(APPEND _IMPORT_CHECK_FILES_FOR_NJLIC::NJLIC-lua-swig-bullet3 "${_IMPORT_PREFIX}/lib/libNJLIC-lua-swig-bullet3.dylib" )

# Import target "NJLIC::NJLIC-lua-swig-njlic" for configuration "RelWithDebInfo"
set_property(TARGET NJLIC::NJLIC-lua-swig-njlic APPEND PROPERTY IMPORTED_CONFIGURATIONS RELWITHDEBINFO)
set_target_properties(NJLIC::NJLIC-lua-swig-njlic PROPERTIES
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/lib/libNJLIC-lua-swig-njlic.dylib"
  IMPORTED_SONAME_RELWITHDEBINFO "@rpath/libNJLIC-lua-swig-njlic.dylib"
  )

list(APPEND _IMPORT_CHECK_TARGETS NJLIC::NJLIC-lua-swig-njlic )
list(APPEND _IMPORT_CHECK_FILES_FOR_NJLIC::NJLIC-lua-swig-njlic "${_IMPORT_PREFIX}/lib/libNJLIC-lua-swig-njlic.dylib" )
